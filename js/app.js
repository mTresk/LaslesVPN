...
// Движение элементов при движении мыши
// var positionX = document.documentElement;
// positionX.addEventListener('mousemove', e => {
// 	positionX.style.setProperty('--x', e.clientX + 'px');
// });
// var positionY = document.documentElement;
// positionY.addEventListener('mousemove', e => {
// 	positionY.style.setProperty('--y', e.clientY + 'px');
// });
